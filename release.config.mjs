...
// semver, updates CHANGELOG.md + src/Directory.Build.props, packs every src/** package,
// publishes to NuGet and creates the tagged GitHub release. Standardized to match core-data.
